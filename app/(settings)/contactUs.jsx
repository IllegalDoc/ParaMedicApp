      ...
      >
        ...
        >
          <View style={styles.infoContainer}>
            ...
            <View>
              <Text>Téléphone</Text>
              <Pressable onPress={() => Linking.openURL(`tel:0793584708`)}>
          ...
          <View style={styles.infoContainer}>
            ...
            <View>
              <Text>Email</Text>
              <Pressable
                onPress={() => Linking.openURL(`mailto:anis921787@gmail.com`)}
              >
          ...
          >
            ...
            <Pressable
              ...
              onPress={() => Linking.openURL(`https://wa.me/213793584708`)}
            >
        ...
        >
          <View style={{ flexDirection: "row", gap: 12, height: 50 }}>
            ...
            <Text style={styles.addressText}>
              Lotissement Cadat, Lot 67 BC, Section 05, Groupe 158,Rouiba, Alger
            </Text>
          </View>
          <Pressable
            style={{ flex: 1, backgroundColor: "transparent", width: "100%" }}
            onPress={() =>
              Linking.openURL("https://maps.app.goo.gl/k48EbzDiigQAAJtKA")
            }
          >
            <MapView
              style={styles.map}
